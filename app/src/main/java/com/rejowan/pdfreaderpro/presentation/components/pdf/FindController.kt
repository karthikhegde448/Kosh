 ...
 */
class FindController internal constructor(private val webView: WebView, private val webInterface: WebInterface? = null) {
    ...
    fun stopFind() {
        ...
        // Reset the session flag so stale callbacks don't fire after next startFind
        webInterface?.resetFindSession()
    }
