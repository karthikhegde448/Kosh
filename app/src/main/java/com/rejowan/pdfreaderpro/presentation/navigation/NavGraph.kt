...
import com.rejowan.pdfreaderpro.presentation.screens.tools.pdftotxt.PdfToTxtScreen
import com.rejowan.pdfreaderpro.presentation.screens.tools.multipages.MultiPagesScreen
import com.rejowan.pdfreaderpro.presentation.screens.tools.texttopdf.TextToPdfScreen
...
fun PdfReaderNavHost(
    ...
    NavHost(
        ...
        // Tool: PDF to TXT
        composable<ToolPdfToTxt> { backStackEntry ->
            val route: ToolPdfToTxt = backStackEntry.toRoute()
            PdfToTxtScreen(
                navController = navController,
        ...
        // Tool: Multiple Pages Per Sheet
        composable<ToolMultiPages> { backStackEntry ->
            val route: ToolMultiPages = backStackEntry.toRoute()
            MultiPagesScreen(
                navController = navController,
                initialFilePath = route.filePath
            )
        ...
        // Tool: Text to PDF
        composable<ToolTextToPdf> {
            TextToPdfScreen(navController = navController)
        }
...
/**
 * Navigate to tool PDF to TXT screen.
 */
fun NavController.navigateToPdfToTxtTool(filePath: String) {
    navigate(ToolPdfToTxt(filePath = filePath))
}

/**
 * Navigate to tool multiple pages per sheet screen.
 */
fun NavController.navigateToMultiPagesTool(filePath: String) {
    navigate(ToolMultiPages(filePath = filePath))
}

/**
 * Navigate to tool text to PDF screen.
 */
fun NavController.navigateToTextToPdfTool() {
    navigate(ToolTextToPdf)
}
